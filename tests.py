...
class TestStringMethods(unittest.TestCase):
    ...
    def test_invalid_mask_to_cidr(self):
        ...
        self.assertEqual('Invalid', self.convert.mask_to_cidr('255.0..0'))
        self.assertEqual('Invalid', self.convert.mask_to_cidr('.255..0'))
        self.assertEqual('Invalid', self.convert.mask_to_cidr('192.168.0.1'))
    ...
    def test_invalid_ipv4(self):
        ...
        self.assertFalse(self.validate.ipv4_validation('192.168.2.a'))
        self.assertFalse(self.validate.ipv4_validation('192.a.2.1'))
